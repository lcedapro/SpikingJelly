...
# python .\infer_conv2int_alexnet.py -data-dir ./ -out-dir ./logs -opt sgd -resume './logs/T4_b1024_sgd_lr0.1_c16_amp_cupy_alex_dec1/checkpoint_max_conv2int.pth' -b 16 -device cpu
# epoch = 0, test_loss = 0.0300, test_acc = 0.8125
# test speed = 728.8764 images/s
# escape time = 2024-11-07 11:20:56
...
class CSNN(nn.Module):
    def __init__(self, T: int, channels: int, use_cupy=False):
        ...
        neuron.IFNode(surrogate_function=surrogate.ATan(), v_threshold=53.0), # 26 * 26 * 2C AlexNet CL2
