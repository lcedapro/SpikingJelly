...
class CSNN(nn.Module):
    def __init__(self, T: int, channels: int, use_cupy=False):
        ...
        layer.Conv2d(1, channels, kernel_size=3, padding=0, stride=1, bias=False),
        layer.BatchNorm2d(channels),
        neuron.IFNode(surrogate_function=surrogate.ATan()),  # 26 * 26
        layer.Conv2d(channels, channels*2, kernel_size=3, padding=0, stride=2, bias=False),
        layer.BatchNorm2d(channels*2),
        neuron.IFNode(surrogate_function=surrogate.ATan()),  # 12 * 12

        layer.Conv2d(channels*2, channels*2, kernel_size=3, padding=0, stride=1, bias=False),
        layer.BatchNorm2d(channels*2),
        neuron.IFNode(surrogate_function=surrogate.ATan()),  # 10 * 10
        layer.Conv2d(channels*2, channels*4, kernel_size=3, padding=0, stride=2, bias=False),
