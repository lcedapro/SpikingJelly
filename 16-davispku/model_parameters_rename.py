...
def main():
    ...
    # 手动指定重命名前后键名
    src = ["conv.0.0.weight", "conv.0.0.bias", "conv.2.0.weight", "conv.2.0.bias", "conv.4.0.weight", "conv.4.0.bias", "fc.2.0.weight", "fc.5.0.weight", "fc.8.0.weight"]
    dst = ["conv.0.weight", "conv.0.bias", "conv.2.weight", "conv.2.bias", "conv.4.weight", "conv.4.bias", "fc.2.weight", "fc.5.weight", "fc.8.weight"]
