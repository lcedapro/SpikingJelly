...
def main():
    ...
    * :ref:`中文API <classify_dvsg.__init__-cn>`
    ...
    # 创建训练集和测试集的数据集实例
    train_dataset = CustomImageDataset(root_dir=train_dir, target_t=1, expand_factor=4, random_en=True)
    test_dataset = CustomImageDataset(root_dir=test_dir, target_t=1, expand_factor=4, random_en=True)
