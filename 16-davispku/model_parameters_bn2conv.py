...
def main():
    # 加载原始权重文件
    checkpoint_path = './logs_t1e4_simple/T_4_b_16_c_2_SGD_lr_0.4_CosALR_48_amp_cupy/checkpoint_max.pth'
    ...
    # 保存新的权重文件
    fused_checkpoint_path = './logs_t1e4_simple/T_4_b_16_c_2_SGD_lr_0.4_CosALR_48_amp_cupy/checkpoint_max_bn2conv.pth'
