...
def main():
    ...
    # 保存新的权重文件
    multiplied_checkpoint_path = './logs_380/T_16_b_256_c_4_SGD_lr_0.2_CosALR_48_amp_cupy-4/checkpoint_max_conv2int.pth'
    torch.save(multiplied_checkpoint, multiplied_checkpoint_path)
    print("所有参数乘并转int8完成，新权重文件保存为 " + multiplied_checkpoint_path)

    # 保存vthr_list
    vthr_list_path = './logs_380/T_16_b_256_c_4_SGD_lr_0.2_CosALR_48_amp_cupy-4/vthr_list.npy'
